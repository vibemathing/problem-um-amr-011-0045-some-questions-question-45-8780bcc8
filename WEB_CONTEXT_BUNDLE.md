...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0045-some-questions-question-45-8780bcc8",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0045-ef82f1409c97",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0045"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let an amenable group $\\Gamma$ act ergodically and essentially faithfully on $X$. Is the groupoid cost of the action $1$? If $\\Gamma$ is finitely presented, is this true for every infinite ergodic action?",
      "version": 1
    },
    "title": "Some Questions — Question 45",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "89f0681b8e4fa1b08242a2315c4c810e1714f8446f50122bbf63171a8e618497"
}
```
